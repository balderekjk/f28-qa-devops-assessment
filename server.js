...
var rollbar = new Rollbar({
  accessToken: '1e5a483644ce4775be63a71d95e6b514',
...
app.get('/api/robots/five', (req, res) => {
  try {
    ...
    rollbar.log('five bots delivered at your door');
...
app.post('/api/duel', (req, res) => {
  try {
    ...
    if (compHealthAfterAttack > playerHealthAfterAttack) {
      playerRecord.losses++;
      rollbar.log('review math, buddy');
      res.status(200).send('You lost!');
    } else {
      playerRecord.losses++;
      rollbar.log('congrats! you passed 3rd grade.');
